...
opt.listchars =
"tab:»·,trail:·,nbsp:·"                 -- Отображение символов для табов, пробелов в конце строки и неразрывных пробелов
...
opt.so = 5                              -- То же, что scrolloff (сокращение)

-- Работа с мышью и кодировкой
opt.mouse = 'a'        -- Включить поддержку мыши во всех режимах
opt.encoding = 'utf-8' -- Кодировка по умолчанию (UTF-8)
